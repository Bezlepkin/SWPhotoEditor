...
public final class PhotoEditorViewController: UIViewController {
    ...
    var stickerButton: HiglihtedButton = {
        let button = HiglihtedButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle("", for: .normal)
        button.titleLabel?.font = UIFont(name: "icomoon", size: 25)
    ...
    private func setupActions() {
        ...
        stickerButton.addTarget(self, action: #selector(stickersButtonTapped), for: .touchUpInside)
    ...
    private func layoutTopToolBarStackView() {
        ...
        topToolBarStackView.addArrangedSubview(stickerButton)
